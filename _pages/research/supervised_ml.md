...
Here is the example of using [sklearn](https://scikit-learn.org/) to implement *linear regression*. [[code link]]({{site.baseurl}}/code/SKLearn_Linear_regression.ipynb)
...
You can find the fully-detailed implementation of *logistic regression* using sigmoid function, cost function, and *regularization* in the [code link]({{site.baseurl}}/code/Logistic_Regression.ipynb).